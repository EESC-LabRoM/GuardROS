...
Purpose
-------
This node records experimental data from the GuardROS system into CSV files.
...
- It writes structured CSV files that can be analyzed later with Python.
...
class RB23ExperimentLoggerNode(Node):
    ...
    def __init__(self) -> None:
        ...
        # stored. The default is inside the user's home directory to avoid
        # requiring administrator permissions.
        self.declare_parameter(
            "base_log_dir",
            str(Path.home() / "guardros_experiments" / "logs"),
        )
